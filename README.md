...
- `short_key`: the 9 characters key that is generated by the url-shorten service
    - it is primary key and partition key
- `original_url`: the original URL that is submitted by user
